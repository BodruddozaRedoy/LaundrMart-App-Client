...

                        {
                            item.status === "Request" && (
                                <View className="flex-row justify-between mt-2">
                                    <TouchableOpacity className="flex-1 border border-[#CBD5E1] rounded-lg py-2 items-center mr-2">
                                        <Text className="text-sm font-medium text-[#1E293B]">
                                            Reject
                                        </Text>
                                    </TouchableOpacity>
...

                        {
                            item.status === "Processing" && (
                                <View className="gap-3 mt-2">
                                    <TouchableOpacity className="flex-1 bg-primary rounded-lg py-2 items-center mr-2">
                                        <Text className="text-sm font-medium text-white">
                                    ...
                                    <TouchableOpacity onPress={() => router.push({ pathname: "/(mart)/report/reportDamage", params: { id: item.id } })} className="flex-1 bg-primary/10 rounded-lg py-2 items-center">
